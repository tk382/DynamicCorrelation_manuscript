\documentclass[aoas,authoryear, preprint]{imsart}
...
% &= \frac{1}{\sigma_1^2 \sigma_2^2 - \rho^2} \begin{bmatrix} u_1 \sigma_2^2 - u_2 \rho & -u_1\rho + u_2\sigma_1^2 \end{bmatrix} \begin{bmatrix} u_1 \\ u_2 \end{bmatrix} \\
% 	&= \frac{1}{\sigma_1^2\sigma_2^2 - \rho^2} \left(
% 	u_1^2\sigma_2^2 - u_1u_2\rho - u_1u_2\rho + u_2^2\sigma_1^2
% 	\right)\\
...
%  (\sigma_1^2\sigma_2^2 - \rho^2)^2
%  }\bm{x}_i\\
%  &= \sum_{i=1}^{N} \frac{u_{i1}u_{i2}x_i(-2\rho'(\sigma_1^2\sigma_2^2 - \rho^2) - 4\rho^2\rho') + 4\sigma_1^2\sigma_2^2x_i\rho\rho'}{(\sigma_1^2\sigma_2^2 - \rho^2)^2}\\
%  &= \sum_{i=1}^{N} \frac{4\sigma_1^2\sigma_2^2\rho\rho' - u_{i1}u_{i2}\rho'(2\sigma_1^2\sigma_2^2 - 2\rho^2)}{(\sigma_1^2\sigma_2^2 - \rho^2)^2}x_i\\
...
\begin{align*}
    ...
    % &= \frac{\hat{\rho}_{22}(\hat{\rho}_{11}\hat{\rho}_{22} - {\rho}_{12}(\hat{\alpha}_0)^2) + \sum_{i=1}^{N} \hat{u}_{i2}^2(\hat{\rho}_{11}\hat{\rho}_{22} - {\rho}_{12}(\hat{\alpha}_0)^2) - (\hat{u}_{i2}^2\hat{\rho}_{11} + \hat{u}_{i1}^2\hat{\rho}_{22} - 2\hat{u}_{i1}\hat{u}_{i2}\rho(\hat{\alpha}_0))\sigma_2^2}{(\hat{\rho}_{11}\hat{\rho}_{22} - \rho^2)^2}\\
    % & = 0\\
    % \tilde{d}_{\sigma_2^2} &= 0\\
    % \tilde{d}_{\alpha} &= -\frac{1}{2}
    % \sum_{i=1}^{N} \rho' \frac{4\sigma_1^2\sigma_2^2\rho - 2\hat{u}_{i1}\hat{u}_{i2}(\sigma_1^2\sigma_2^2 + \rho^2) - 2\rho(\sigma_1^2\rho - \rho^2)}{(\sigma_1^2\sigma_2^2 - \rho^2)^2}x_i\\
    % &= -\frac{1}{2}\sum_{i=1}^{2}\rho' \frac{2\sigma_1^2\sigma_2^2\rho + 2\rho^3 - 2\hat{u}_{i1}\hat{u}_{i2}(\sigma_1^2 + \sigma_2^2 + \rho^2)}{(\sigma_1^2\sigma_2^2- \rho^^2)^2}\\
    % &= -\frac{1}{2} \sum_{i=1}^{N} \rho' \frac{2(\sigma_1^2\sigma_2^2 + \rho^2)(\rho - \hat{u}_{i1}\hat{u}_{i2})}{(\sigma_1^2\sigma_2^2 - \rho^2)^2}\\
    % &= \sum_{i=1}^{N} \rho' \frac{(\sigma_1^2\sigma_2^2 + \rho^2)(\hat{u}_{i1}\hat{u}_{i2} - \rho)}{(\sigma_1^2\sigma_2^2 - \rho^2)^2}\bm{x}_i
\end{align*}
...
%     2\rho_{11^2} & 2\rho^2 & 2\frac{\sigma_1^2\rho}{\rho'}\bm{x}_i^T\\
%     2\rho^2 & 2\sigma_2^2^2 & 2\frac{\sigma_2^2\rho}{\rho'}\bm{x}_i^T\\
%     2\frac{\sigma_1^2\rho}{\rho'}\bm{x}_i & 2\frac{\sigma_2^2\rho}{\rho'}\bm{x}_i & \frac{\sigma_1^2\sigma_2^2+\rho^2}{\rho'^2}(\bm{x}_i\bm{x}_i^T)^{-1}
%     \end{bmatrix}
% \end{equation}
